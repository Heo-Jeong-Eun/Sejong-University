...
public class AddMyinfoRequest extends StringRequest { //StringRequest를 상속받아 사용
    final static private String URL = "add_myinfo.php";
    ...
    // 맵 생성
    public AddMyinfoRequest(String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
