...
public class RoomTimeRequest extends StringRequest { //StringRequest를 상속받아 사용
    final static private String URL = "timeroom.php";
    ...
    // 맵 생성
    public RoomTimeRequest(String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
